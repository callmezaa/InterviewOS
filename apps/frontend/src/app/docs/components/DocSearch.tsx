...
import { Search, Sparkles, BookOpen, Puzzle, History } from 'lucide-react';
...
const searchHints: { query: string; section: DocSection; label: string }[] = [
  { query: 'getting started', section: 'getting-started', label: 'Getting Started Guide' },
  { query: 'setup interview', section: 'getting-started', label: 'Setup Interview' },
  { query: 'best practices', section: 'best-practices', label: 'Best Practices' },
  { query: 'tips', section: 'best-practices', label: 'Tips & Tricks' },
  { query: 'integrations', section: 'integrations', label: 'Integration Guides' },
  { query: 'slack', section: 'integrations', label: 'Slack Integration' },
  { query: 'changelog', section: 'changelog', label: 'Latest Changes' },
  { query: 'release notes', section: 'changelog', label: 'Release Notes' },
];

const sectionIcon: Record<DocSection, React.ElementType> = {
...
export function DocSearch({ value, onChange, activeSection, onNavigate }: DocSearchProps) {
