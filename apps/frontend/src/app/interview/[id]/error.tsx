...
import { RefreshCw, ChevronDown, Terminal, LogOut } from 'lucide-react';
      ...
      >
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <p className="text-body-muted/50 text-[14px] leading-relaxed max-w-[340px]">
            A problem occurred in the interview workspace. Your session data is preserved.
          </p>
        </div>
